...
public class DeviceThreeActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_device_three);
        TAG = DeviceThreeActivity.class.getSimpleName();
        btnScanBl = (Button)findViewById(R.id.btn_scan_bl);
        btnDeviceBack = (Button) findViewById(R.id.btn_device_three_back);
        ivBlFlag = (ImageView) findViewById(R.id.iv_bl_connect_flag);
        et_device_N = (EditText) findViewById(R.id.et_device_three);
        tvNameAddress = (TextView) findViewById(R.id.tv_device_three_name_address);
        //获取蓝牙适配器
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    if(standDeviceAddress.equals(device.getAddress())) {
                        ...
                        Intent intent = new Intent(DeviceThreeActivity.this, BluetoothLeService.class);
                        intent.putExtra("type","type03");
    ...
    private final BroadcastReceiver mGattUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothLeService.ACTION_GATT_CONNECTED.equals(action)) {
                ...
                Toast.makeText(DeviceThreeActivity.this,"蓝牙连接失败！",Toast.LENGTH_LONG).show();
    ...
    private void displayData(String data) {
        if (data != null) {
            ...
            if(data.length()==18){
                ...
                int data_16 = Util.OxStringtoInt(dataSub);
                et_device_N.setText(data_16+"");
            }else{
                et_device_N.setText(0+"");
            }
        }
    }
    @Override
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.btn_scan_bl:
                ...
                break;
            case R.id.btn_device_three_back:
                finish();
                break;
        }
    }
