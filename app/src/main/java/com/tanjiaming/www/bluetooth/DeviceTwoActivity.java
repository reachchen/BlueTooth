...
public class DeviceTwoActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TAG = DeviceTwoActivity.class.getSimpleName();
        btnScanBl = (Button)findViewById(R.id.btn_device_two_scan);
        btnDeviceBack = (Button)findViewById(R.id.btn_device_two_back);
        ivBlFlag = (ImageView) findViewById(R.id.iv_enable_flag);
        et_device_N = (EditText) findViewById(R.id.et_device_two);
        tvNameAddress = (TextView) findViewById(R.id.tv_device_two_name_address);
        //获取蓝牙适配器
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    if(standDeviceAddress.equals(device.getAddress())) {
                        ...
                        Intent intent = new Intent(DeviceTwoActivity.this, BluetoothLeService.class);
    ...
    private final BroadcastReceiver mGattUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothLeService.ACTION_GATT_CONNECTED.equals(action)) {
                ...
                Toast.makeText(DeviceTwoActivity.this,"数据读取失败，请重试！",Toast.LENGTH_LONG).show();
