...
public class DeviceFourActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TAG = DeviceFourActivity.class.getSimpleName();
        btnScanBl = (Button)findViewById(R.id.btn_scan_device_four);
        btnDeviceBack = (Button)findViewById(R.id.btn_device_four_back);
        ivBlFlag = (ImageView) findViewById(R.id.iv_device_four_connect_flag);
        et_device_N = (EditText) findViewById(R.id.et_device_four);
        tvNameAddress = (TextView) findViewById(R.id.tv_device_four_name_address);
        //获取蓝牙适配器
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    if(standDeviceAddress.equals(device.getAddress())) {
                        ...
                        Intent intent = new Intent(DeviceFourActivity.this, BluetoothLeService.class);
    ...
    private final BroadcastReceiver mGattUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothLeService.ACTION_GATT_CONNECTED.equals(action)) {
                ...
                Toast.makeText(DeviceFourActivity.this,"读取数据失败，请重试。",Toast.LENGTH_LONG).show();
    ...
    private void displayData(String data) {
        if (data != null) {
            ...
            if(data.length()==18){
                ...
                double data_16 = Util.OxStringtoInt(dataSub)*0.01;
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.btn_device_one:
                ...
                break;
            case R.id.btn_device_four_back:
                finish();
                break;
        }
    }
